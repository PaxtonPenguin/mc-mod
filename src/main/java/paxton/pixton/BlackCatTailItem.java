...
public class BlackCatTailItem extends Item{
    public BlackCatTailItem() {
        super(new Item.Properties().stacksTo(1).setId(ItemIds.BLACK_CAT_TAIL)
                ...
                .component(Components.TOOLTIP, new Tooltip("*wags tail* :3"))
