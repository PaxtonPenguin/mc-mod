...
public class PedestalMenu extends AbstractContainerMenu {
    ...
    public PedestalMenu(final int containerId, final Inventory inventory) {
		this(containerId, inventory, new SimpleContainer(SLOTS_COUNT));
	}

    public PedestalMenu(final int containerId, final Inventory inventory, final Container container) {
		super(MenuTypes.PEDESTAL, containerId);
